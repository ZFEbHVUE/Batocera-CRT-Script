...
perform_backup_once() {
    if [ ! -f "$FLAG_FILE" ]; then
        ...
        install -D -m 0755 /usr/lib/python3.12/site-packages/configgen/emulatorlauncher.py /userdata/system/Batocera-CRT-Script/backup/usr/lib/python3.12/site-packages/configgen/emulatorlauncher.py.backup
        install -D -m 0644 /usr/lib/python3.12/site-packages/configgen/utils/videoMode.py /userdata/system/Batocera-CRT-Script/backup/usr/lib/python3.12/site-packages/configgen/utils/videoMode.py.backup
    ...
    if [ -f "$FLAG_FILE" ]; then
        ...
        case $choice in
            ...
            "Restore")
                ...
                install -D -m 0755 /userdata/system/Batocera-CRT-Script/backup/usr/lib/python3.12/site-packages/configgen/emulatorlauncher.py.backup /usr/lib/python3.12/site-packages/configgen/emulatorlauncher.py
                install -D -m 0644 /userdata/system/Batocera-CRT-Script/backup/usr/lib/python3.12/site-packages/configgen/utils/videoMode.py.backup /usr/lib/python3.12/site-packages/configgen/utils/videoMode.py
